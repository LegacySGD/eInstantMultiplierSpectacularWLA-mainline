...
public class MultiplierSpectacularWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(MultiplierSpectacularWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/MultiplierSpectacularWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/MultiplierSpectacularWLAIW/InitOutcome.xml").getDocumentElement();
